...
//  --------- 외부클래스에서 사용하기
//  TODO: 속성, 생성자, 함수
    Attr attr = new Attr();     // 내부클래스를 일반 속성으로 정의
    Share share = new Share();  // 공유 내부클래스를 일반 속성으로 정의
//  TODO: 테스트 #1
//    static Attr attr2 = new Attr(); // 안됨 : Attr(일반 속성 내부클래스)
    static Share share2 = new Share(); // 가능 : Share(공유 속성 내부클래스)
